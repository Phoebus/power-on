...
const CLICK_SFX_PATH : String = "res://assets/audio/click.ogg"
const CHA_CHING_SFX_PATH : String = "res://assets/audio/cha_ching.ogg"
const REMOVE_FROM_CART_SFX_PATH : String = "res://assets/audio/remove_from_cart.ogg"
const BACK_BUTTON_SFX_PATH : String = "res://assets/audio/back_button_sound.ogg"
const COMPLETED_ORDER_SFX_PATH : String = "res://assets/audio/completed_order_sound.ogg"
